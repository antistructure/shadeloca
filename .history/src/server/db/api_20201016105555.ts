...
const baseUrl = process.env.DEPLOY_PRIME_URL; //dev ? 'http://localhost:3000' : 'https://www.shadeloca.com';
...
const getProducts = () =>
  fetch(`${baseUrl}/.netlify/functions/products-read-all`).then(res => console.log(res))
  .catch(err => console.log(err));
